...
def check_exist_location(ra, dec,radius):
    ...
    final = results[((results['obs_collection']=='GALEX') | (results['obs_collection']=='PS1')) & 
                    ((results['dataproduct_type']=='image') | (results['dataproduct_type']=='cube'))]
    ...
    ObjIDs = data_products_by_obs[((data_products_by_obs['description']==descript) | 
                                  ...
                                  ((data_products_by_obs['project']=='MIS') | 
                                    (data_products_by_obs['project']!='PS1'))]
